import * as utils from "handlebars-kit/lib/utils";
import moment from "moment";
import { HelperGroup } from "./types";

/**
 * @exports date
 */
export const date: HelperGroup = {};
 ...
 * @see {@link moment}
 */
date.date = (...args) => date.moment(...args);
 ...
 * @api public
 */
date.formatDate = function (date, _format) {
  let format = _format;
